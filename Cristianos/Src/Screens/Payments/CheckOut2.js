      ...
      <ImageBackground
        ...
        <ScrollView>
          ...
          <View style={styles.infocontainer}>
            <Text style={styles.shamsstyle}>Shams ul Din</Text>
            <Text style={styles.detailstyle}>indo@techxpert.io</Text>
            <Text style={styles.detailstyle}>+1 625 325 425</Text>
          </View>
          ...
          <View
            ...
            <View
              ...
              <RadioButton
                status={firstRadio == true ? 'checked' : 'unchecked'}
